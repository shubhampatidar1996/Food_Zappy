                                ...
                                <div class="header_wrapper_inner">
                                    ...
                                    <div class="main_menu_inner">
                                        ...
                                        <div class="menu">
                                            <nav>
                                                <ul>
                                                    <li><a href="index.jsp"><font size="3px"> Home </font></a></li>
                                                    </li>
                                                    <li><a href="#"><font size="3px"> What's Zappy</font></a> </li>
                                                    </li>
                                                    <li><a href="#"><font size="3px"> Contact Us </font></a></li>
                                                    </li>
                                                    <li><a href="Signup.jsp"><font size="3px"> SignUp</font></a></li>
                                                    </li>
                                                    <li><a href="Login.jsp"><font size="3px"> Login</font></a></li>
                                                    </li>
                                                  </a>
                                                    </li>
                                                        </ul>    
                                    ...
                                    <div class="header_right_info d-flex">
                                        ...
                                        <li><a href="ViewCart"><font size="3px"><i class="ion-android-cart"><b><span class="cart_count">${count}</span></span>View Cart</b></i></font></a> </li>
                                        </div>  
                        </div>
                    </div>
                </header>
